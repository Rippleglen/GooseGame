...
// -------------------------------------------------------------------------------------------------------------------------------------------------#-#
// -------------------------------------------------------------------------------------------------------------------------------------------------#-#
// THIS CONTROLS POINTER EVENTS FOR THE DRAGGABLE OBJECTS AND TURNS OFF EVENTS FOR OTHER ELEMENTS WHEN AN OBJECT IS BEING DRAGGED----------------------#-#
...
// ------------------------------------------------------------------------------#-#
// ------------------------------------------------------------------------------#-#
// --------------THIS INITIALISES ALL OF THE THREE.JS CANVAS & PHYSICS--------------#-#


  const scene = new THREE.Scene(); //This initialises the three.js scene


  const world = new CANNON.World(); // This initialises the physics environment
  world.gravity.set(0, 0, 0);  // This turns off gravity so the objects dont fall to the bottom of page.

  const camera = new THREE.PerspectiveCamera(
    45, // Field of view, for the camera
    window.innerWidth / window.innerHeight, // Aspect ratio for the camera so it can handle dynamically being resized.
...
// ------------------------------------------------------------------------------#-#
// ------------------------------------------------------------------------------#-#
// --------------THIS HANDLES THE DYNAMIC WINDOW RESIZING FOR THREE.JS--------------#-#
...
// ------------------------------------------------------------------------------#-#
// ------------------------------------------------------------------------------#-#
// THIS HANDLES LOADING IN THE MODELS AS WELL AS PUTTING THEM AT THE DEFINED POINTS-#-#
